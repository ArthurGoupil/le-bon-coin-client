      ...
      <div className="header-top d-flex justify-center">
        <div className="header-top-center d-flex align-center space-between">
          <div className="header-top-center-left d-flex space-between align-center">
            ...
            <button className="post-offer-button-header d-flex align-center">
              <FontAwesomeIcon
                className="icon-plus"
            ...
            <div className="search-header selected-header d-flex align-center">
              <FontAwesomeIcon
                className="icon-search"
                icon={['fas', 'search']}
              />
              <span className="is-18">Rechercher</span>
            </div>
          </div>
